        ...
        <div class="nav-center d-none d-md-flex">
          ...
          >
            ...
            <v-list class="dropdown-menu">
              ...
              <v-list-item
                to="/faq"
                :class="['dropdown-item', { 'dropdown-item-active': isDropdownItemActive('/faq') }]"
              >
                FAQ
              </v-list-item>
              <v-list-item
          ...
          <v-menu v-model="menuCompte" location="bottom" :close-on-content-click="false" offset="8">
            <template #activator="{ props }">
              <v-btn
                variant="text"
                class="nav-link"
      ...
      <v-container>
        <v-col cols="12">
              ...
              <div class="footer-top-content">
                ...
                <div class="footer-cta-question">
                  <h3 class="text-h6 text-md-h5 font-weight-bold">
                    Prêt à transformer votre recrutement international ?
                  </h3>
                </div>
          ...
          <v-row class="footer-main-section">
            ...
            <v-col cols="12" sm="6" md="3">
              <div class="footer-column-header mb-4">Adresse</div>
              <div class="d-flex flex-column ga-3 footer-address">
                <div class="footer-address-line">GlobalKey Partners Ltd</div>
                <div class="footer-address-line">128 City Road</div>
                <div class="footer-address-line">London</div>
                <div class="footer-address-line">EC1V 2NX</div>
          ...
          <v-row>
            <v-col cols="12">
              <div class="footer-copyright">
                <div class="text-center text-body-2">Copyright © {{ year }} Global Work Hub</div>
              </div>
            </v-col>
          </v-row>
        </v-col>
...
.nav-link-active {
  ...
  font-weight: 600;
  background-color: rgba(255, 122, 60, 0.1) !important;
}
...
.dropdown-item:hover {
  ...
  border-left-color: rgba(255, 122, 60, 0.6);
...
.dropdown-item-active {
  background: linear-gradient(
    90deg,
    rgba(255, 122, 60, 0.25) 0%,
    rgba(255, 122, 60, 0.1) 100%
  ) !important;
  color: #ff7a3c !important;
  font-weight: 600;
  border-left-color: #ff7a3c;
  box-shadow: 0 2px 8px rgba(255, 122, 60, 0.2);
}

.dropdown-item-active::before {
  width: 100%;
  background: linear-gradient(90deg, rgba(255, 122, 60, 0.3), transparent);
}
