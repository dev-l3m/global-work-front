...
const props = withDefaults(
  ...
  }>(),
  {
    ...
    heroAlt:
      "Équipe internationale de professionnels qualifiés pour le recrutement et l'externalisation RH - Global Work Hub connecte les entreprises aux meilleurs talents dans 15+ pays",
  }
)
