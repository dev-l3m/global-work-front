...
<template>
  <v-container id="pourquoi" class="py-16">
    <div class="d-flex align-end justify-space-between flex-wrap ga-4 mb-10">
      <div class="section-header">
        ...
        <div class="text-body-1 text-medium-emphasis" style="max-width: 600px">
          Le recrutement international ne doit pas être un parcours du combattant. Nous offrons une
          alternative fiable, encadrée et performante aux freelances instables et aux recrutements
          locaux coûteux.
        </div>
      </div>
      <v-btn
